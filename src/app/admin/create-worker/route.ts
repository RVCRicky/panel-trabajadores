...
export async function POST(req: Request) {
  try {
    ...
    // 1) Cliente con ANON + token del usuario actual para verificar que es ADMIN via RLS
    ...
    // Comprobar admin real con app_admins (RLS)
    ...
    // 2) Cliente SERVICE ROLE para crear usuario Auth + insertar en workers (server only)
